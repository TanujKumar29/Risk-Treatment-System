 ...
 * Residual_Risk.java
 *
 * Created on Sep 16, 2012, 10:57:06 PM
 */
 ...
 * @author gosavpus
 */
public class Residual_Risk extends javax.swing.JFrame {

    Projects projects;
   
    /** Creates new form Residual_Risk */
    public Residual_Risk() {
        initComponents();
    }
     public Residual_Risk(Projects projects) {
    ...
    private void initComponents() {
        ...
        jTableAddRiskTreatment.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Asset Name", "Threat", "Vulnerability", "Risk Category", "Risk Exposure", "Risk Treatment Approach", "Decision Reason", "Comment", "Residual Risk Likelihood", "Residual Risk Impact", "Residual Risk Exposure", "Residual Risk Category", "AssetId", "RiskEvaluationId", "ThreatVulnId", "ThreatId", "VulnId", "RiskTreatmentId", "ResidualRiskId"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Float.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Float.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class
            };
        ...
        jTableAddRiskTreatment.getColumnModel().getColumn(8).setCellEditor(new DefaultCellEditor(
            ...
            jTableAddRiskTreatment.getColumnModel().getColumn(3).setCellEditor(new DefaultCellEditor(
                ...
                jTableAddRiskTreatment.getColumnModel().getColumn(9).setCellEditor(new DefaultCellEditor(
                    new JComboBox(new DefaultComboBoxModel(new String[] {
                        cg.arr1[0],
                        cg.arr1[1],
                        cg.arr1[2],
                    ...
                    jTableAddRiskTreatment.getColumnModel().getColumn(13).setMinWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(13).setPreferredWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(13).setMaxWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(14).setMinWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(14).setPreferredWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(14).setMaxWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(15).setMinWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(15).setPreferredWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(15).setMaxWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(16).setMinWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(16).setPreferredWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(16).setMaxWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(17).setMinWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(17).setPreferredWidth(0);
                    jTableAddRiskTreatment.getColumnModel().getColumn(17).setMaxWidth(0);

                    jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
                    jLabel2.setText("Enter Residual Risks");
                    ...
                    jLabel3.setText("Residual Risk Calculate");
                    ...
                    jTableRisksTreatmentRegister.setModel(new javax.swing.table.DefaultTableModel(
                        ...
                        new String [] {
                            "", "Index", "Asset Name", "Threat", "Vulnerability", "Risk Category", "Risk Exposure", "Risk Treatment", "Description", "Comment", "VulnId", "Residual Risk Likelihood", "Residual Risk Impact", "Residual Risk Exposure", "Residual Risk Category", "AssetId", "RiskEvaluationId", "ThreatVulnId", "ThreatId", "RiskTreatmentId", "ResidualRiskId"
                        }
                    ) {
                        Class[] types = new Class [] {
                            java.lang.Boolean.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Float.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Float.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class
                        };
                        boolean[] canEdit = new boolean [] {
                            true, false, true, false, false, false, false, true, true, true, false, true, true, true, true, false, false, false, false, false, false
                        };
                    ...
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(16).setMinWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(16).setPreferredWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(16).setMaxWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(17).setMinWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(17).setPreferredWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(17).setMaxWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(18).setMinWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(18).setPreferredWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(18).setMaxWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(19).setMinWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(19).setPreferredWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(19).setMaxWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(20).setMinWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(20).setPreferredWidth(0);
                    jTableRisksTreatmentRegister.getColumnModel().getColumn(20).setMaxWidth(0);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        List<RiskTreatment> riskTreatment = new ArrayList<RiskTreatment>();
   //   List<Residual_Risk> residual_Risks = new ArrayList<Residual_Risk>();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Residual_Risk().setVisible(true);
            }
        });
    }
...
MyItemListener it;
    ...
    private RiskTreatment readTableRow(JTable table,int row)
    {
                ...
                RiskTreatment riskTreatment = new RiskTreatment();
                com.rts.pojoclasses.Residual_Risk residual_Risk = new com.rts.pojoclasses.Residual_Risk();

                //System.out.println("Searching for Row: "+row+"Column:"+(2-i)+"value: "+;
                try
                {
                   
                    residual_Risk.getRiskTreatment().getRiskEvaluation().getAssetsThreatsVuln().getAssets().setAssetsName((String)table.getValueAt(row, 2-i));
                     residual_Risk.getRiskTreatment().getRiskEvaluation().getAssetsThreatsVuln().getThreats().setThreatName((String)table.getValueAt(row, 3-i));
                     residual_Risk.getRiskTreatment().getRiskEvaluation().getAssetsThreatsVuln().getVulnerabilities().setVulnarabilityName((String)table.getValueAt(row, 4-i));
                     residual_Risk.getRiskTreatment().getRiskEvaluation().setRiskCategory((String)table.getValueAt(row, 5-i));
                    

                    residual_Risk.getRiskTreatment().getRiskEvaluation().setRiskExposure((Float)table.getValueAt(row, 6-i));

                    residual_Risk.getRiskTreatment().setRiskTreatmentApproach((String)table.getValueAt(row, 7-i));

                    residual_Risk.getRiskTreatment().setComment((String)table.getValueAt(row, 8-i));
                    residual_Risk.getRiskTreatment().setRiskDecisionReason((String)table.getValueAt(row, 9-i));

                    residual_Risk.setResRiskLikelihood((Integer)table.getValueAt(row, 10-i));
                    residual_Risk.setResRiskImpact((Integer)table.getValueAt(row, 11-i));
                    residual_Risk.setResRiskExposure((Float)table.getValueAt(row, 12-i));
                    residual_Risk.setResRiskCategory((String)table.getValueAt(row, 13-i));

                     residual_Risk.getRiskTreatment().getRiskEvaluation().getAssetsThreatsVuln().getAssets().setAssetId((Integer)table.getValueAt(row, 14-i));
                     residual_Risk.getRiskTreatment().getRiskEvaluation().setRiskEvaluationId((Integer)table.getValueAt(row, 15-i));

                    residual_Risk.getRiskTreatment().getRiskEvaluation().getAssetsThreatsVuln().setAssetsThreatsVulnId((Integer)table.getValueAt(row, 16-i));
                    residual_Risk.getRiskTreatment().getRiskEvaluation().getAssetsThreatsVuln().getThreats().setThreatId((Integer)table.getValueAt(row, 17-i));

                    residual_Risk.getRiskTreatment().getRiskEvaluation().getAssetsThreatsVuln().getVulnerabilities().setVulnarabilityId((Integer)table.getValueAt(row, 18-i));
                    residual_Risk.getRiskTreatment().setRiskTreatmentId((Integer)table.getValueAt(row, 19-i));
                    residual_Risk.setResidualId((Integer)table.getValueAt(row, 20-i));
...
private String[] getAssetNameList(){
    ...
    String query="Select assetsName from Assets where projectId.projectId="+8; ///for comHem project I have added 8//where projectId=project.getProjectId()
