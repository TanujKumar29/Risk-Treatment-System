...
public class SFRisk_EvaluationFrame extends javax.swing.JFrame
{
    SFID sfid;

    /** Creates new form Risk_EvaluationFrame */
    public SFRisk_EvaluationFrame() {
        initComponents();
        loadTable(jTableRisksRegister);
    }
    public SFRisk_EvaluationFrame(SFID sfid)
    {
        this.sfid = sfid;
        initComponents();
        loadTable(jTableRisksRegister);
...
jTableRisksRegister.getColumnModel().getColumn(10).setMinWidth(20);
jTableRisksRegister.getColumnModel().getColumn(10).setPreferredWidth(20);
jTableRisksRegister.getColumnModel().getColumn(10).setMaxWidth(20);
...
jButtonUpdate.addActionListener(new java.awt.event.ActionListener() {
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ...
        for(int i=0;i<jTableAddRisks.getRowCount();i++){
            ...
            if(riskEvaluation.get(i).getSfassetsThreatsVuln().getThreats().getThreatName()==null ||
                    riskEvaluation.get(i).getSfassetsThreatsVuln().getVulnerabilities().getVulnarabilityName()==null) {
         ...
         res=MySQLDAOFactory.getDAOFactory().getSFRiskEvaluationDao().insertSFRiskEvaluation(riskEvaluation.get(i));
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        // TODO add your handling code here:
        SFRiskEvaluation riskEvaluation = new SFRiskEvaluation();
        ...
        for(int i=0;i<jTableRisksRegister.getRowCount();i++){
            if((Boolean)jTableRisksRegister.getValueAt(i, 0)==true){
                ...
                if(jTableRisksRegister.getValueAt(i, 3)==null||jTableRisksRegister.getValueAt(i, 8)==null
                    ...
                    int res = MySQLDAOFactory.getDAOFactory().getSFRiskEvaluationDao().insertSFRiskEvaluation(riskEvaluation);
                    if(res!=-1){
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        // TODO add your handling code here:
        int startIndex = -1;
        SFRiskEvaluationDao riskEvaluationDAO = MySQLDAOFactory.getDAOFactory().getSFRiskEvaluationDao();
        SFRiskEvaluation riskEvaluation = new SFRiskEvaluation();
        ...
        for (int i = (selectColumnVal.length - 1); i >= 0; i--) {
            if (selectColumnVal[i] == true) {
                ...
                System.out.println("value of jTableRisksRegister.getValueAt(i, 10)=="+jTableRisksRegister.getValueAt(i, 10));
                if (jTableRisksRegister.getValueAt(i, 10)==null) {
                    ...
                    riskEvaluation = readTableRow(jTableRisksRegister,i);
                    int row = riskEvaluationDAO.deleteSFRiskEvaluation(riskEvaluation);
                    if (row == 0) {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SFRisk_EvaluationFrame().setVisible(true);
            }
        });
    }
...
//*****************************************************My methods****************
private SFRiskEvaluation readTableRow(JTable table,int row){
    int i=0;
    ...
    try {
    riskEvaluation.getSfassetsThreatsVuln().getAssets().setAssetsName((String)table.getValueAt(row, 2-i));

    riskEvaluation.getSfassetsThreatsVuln().getAssets().setAssetsValue((Float)table.getValueAt(row, 3-i));


//    riskEvaluation.getAssetsThreatsVuln().getThreats().setThreatType((String)table.getValueAt(row, 4-i));
    riskEvaluation.getSfassetsThreatsVuln().getThreats().setThreatName((String)table.getValueAt(row, 4-i));
    riskEvaluation.getSfassetsThreatsVuln().getVulnerabilities().setVulnarabilityName((String)table.getValueAt(row, 5-i));
    ...
    if(table==jTableAddRisks)
        i++;
    riskEvaluation.getSfassetsThreatsVuln().getAssets().setAssetId((Integer)table.getValueAt(row, 11-i));
    riskEvaluation.getSfassetsThreatsVuln().setAssetsThreatsVulnId((Integer)table.getValueAt(row, 12-i));
    riskEvaluation.getSfassetsThreatsVuln().getThreats().setThreatId((Integer)table.getValueAt(row, 13-i));
    riskEvaluation.getSfassetsThreatsVuln().getVulnerabilities().setVulnarabilityId((Integer)table.getValueAt(row, 14-i));
    ...
    System.out.println("Data read from the Table is :"+riskEvaluation);
        ...
        System.out.println("Data is not enter correctly please check."+e.getMessage());
...
private String[] getAssetNameList(){
    ...
    String query="Select assetsName from SF_Assets where SFId.SFId="+sfid.getSFId();//where projectId=project.getProjectId()
...
//
        ...
        riskEvaluation = MySQLDAOFactory.getDAOFactory().getSFRiskEvaluationDao().fetchSFRiskEvaluation("from SFRiskEvaluation");
        for(int i=0;i<riskEvaluation.size();i++){
            ...
            table.getModel().setValueAt(riskEvaluation.get(i).getSfassetsThreatsVuln().getAssets().getAssetsName(), i, 2);
            table.getModel().setValueAt(riskEvaluation.get(i).getSfassetsThreatsVuln().getAssets().getAssetsValue(), i, 3);

               //Load other fields threts and Vulnerabilityr
                table.setValueAt(riskEvaluation.get(i).getSfassetsThreatsVuln().getThreats().getThreatName(), i, 4);
                table.setValueAt(riskEvaluation.get(i).getSfassetsThreatsVuln().getVulnerabilities().getVulnarabilityName(), i,5);
//                threatList.add(assetThreatsVulnList.get(j).getThreats().getThreatName());
                ...
                table.setValueAt(riskEvaluation.get(i).getSfassetsThreatsVuln().getAssets().getAssetId(), i, 11);
                table.setValueAt(riskEvaluation.get(i).getSfassetsThreatsVuln().getAssetsThreatsVulnId(), i, 12);
                table.setValueAt(riskEvaluation.get(i).getSfassetsThreatsVuln().getThreats().getThreatId(), i, 13);
                table.setValueAt(riskEvaluation.get(i).getSfassetsThreatsVuln().getVulnerabilities().getVulnarabilityId(), i, 14);
