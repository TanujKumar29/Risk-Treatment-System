 ...
 * @author bhandrah
 */
public class SFRisk_TreatmentFrame extends javax.swing.JFrame {

    /** Creates new form Risk_TreatmentFrame */
    public SFRisk_TreatmentFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTableAddRiskTreatment.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Asset Name", "Threat", "Vulnerability", "Risk Category", "Risk Exposure", "Risk Treatment Approach", "Control Measure", "Comment", "RiskEvaluationId", "ThreatVulnId", "ThreatId", "VulnId", "AssetId"
            }
        ) {
        ...
        jTableAddRiskTreatment.getColumnModel().getColumn(5).setCellEditor(new DefaultCellEditor(jComboBoxTreatList));

        jTableAddRiskTreatment.getColumnModel().getColumn(6).setCellEditor(new DefaultCellEditor(jComboBoxControlList));
    ...
    jTableRisksTreatmentRegister.setModel(new javax.swing.table.DefaultTableModel(
        ...
        new String [] {
            "", "Index", "Asset Name", "Threat", "Vulnerability", "Risk Category", "Risk Exposure", "Risk Treatment", "Control Measure", "Comment", "RiskEvaluationId", "ThreatVulnId", "ThreatId", "VulnId", "AssetId", "RiskTreatmentId"
        }
    ) {
        Class[] types = new Class [] {
    ...
    jTableRisksTreatmentRegister.getColumnModel().getColumn(7).setCellEditor(new DefaultCellEditor(jComboBoxTreatList));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for(int i=0;i<jTableAddRiskTreatment.getRowCount();i++){
         ...
         res=MySQLDAOFactory.getDAOFactory().getSFRiskTreatmentDao().insertSFRiskTreatment(riskTreatment.get(i));
        ...
        for(int i=0;i<jTableRisksTreatmentRegister.getRowCount();i++){
            if((Boolean)jTableRisksTreatmentRegister.getValueAt(i, 0)==true){
                ...
                if(jTableRisksTreatmentRegister.getValueAt(i, 3)==null||jTableRisksTreatmentRegister.getValueAt(i, 6)==null
                    ...
                    int res = MySQLDAOFactory.getDAOFactory().getSFRiskTreatmentDao().insertSFRiskTreatment(riskTreatment);
                    if(res!=-1){
...
private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
            // TODO add your handling code here:
        int startIndex = -1;
        SFRiskTreatmentDao riskTreatmentDAO = MySQLDAOFactory.getDAOFactory().getSFRiskTreatmentDao();
        SFRiskTreatment riskTreatment = new SFRiskTreatment();
        ...
        for (int i = (selectColumnVal.length - 1); i >= 0; i--) {
            if (selectColumnVal[i] == true) {
                ...
                if (jTableRisksTreatmentRegister.getValueAt(i, 15)==null) {
                    ...
                    riskTreatment = readTableRow(jTableRisksTreatmentRegister,i);
                    int row = riskTreatmentDAO.deleteSFRiskTreatment(riskTreatment);
                    if (row == 0) {
...
//
//        }
        } else if(jTableAddRiskTreatment.getSelectedColumn()==6){
            if(Config.riskTreatment[0].equals((String)jTableAddRiskTreatment.getValueAt(row, 5))){
                //jTableAddRiskTreatment.setValueAt(assetValue, row, called);
                jTableAddRiskTreatment.getColumnModel().getColumn(6).setCellEditor(new DefaultCellEditor(jComboBoxTreatList));
...
private void jButtonReset2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonReset2ActionPerformed
    ...
    */
    ...
    private void jComboBoxTreatListItemStateChanged(java.awt.event.ItemEvent evt) {
        // TODO add your handling code here:
        int row = jTableAddRiskTreatment.getSelectedRow();
        if(row >0 && jTableAddRiskTreatment.getSelectedRowCount()==1 ){
            
        }
        //System.out.println("Item selection changed"+jComboBoxTreatList.getSelectedItem());
        
            if(row>=0 && jTableAddRiskTreatment.getValueAt(row,5)!=null){
             //System.out.println("VAlue:"+jTableAddRiskTreatment.getValueAt(row,5));
                System.out.println("Item state event called:"+jComboBoxTreatList.getSelectedItem() + " For Row"+jTableAddRiskTreatment.getSelectedRow()+" Open Window!" );
    ...
    private void jComboBoxTreatListActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        int row=jTableAddRiskTreatment.getSelectedRow();
        if(row>=0 && jTableAddRiskTreatment.getValueAt(row, 5)==null){
        System.out.println("First Click:"+jTableAddRiskTreatment.getValueAt(row, 5)+" Command:"+jComboBoxTreatList.getSelectedItem()+" Open window");
...
//        jComboBoxTreatListActionPerformed(evt);
    ...
    private void jComboBoxTreatListMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        int row = jTableAddRiskTreatment.getSelectedRow();
        if (row>=0)
        jTableAddRiskTreatment.setValueAt("select", row, 6);
    }
 
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SFRisk_TreatmentFrame().setVisible(true);
            }
        });
    }
...
int called=0;
//*****************************************************My methods****************
private SFRiskTreatment readTableRow(JTable table,int row){
    int i=0;
    ...
    try {
    riskTreatment.getRiskEvaluation().getSfassetsThreatsVuln().getAssets().setAssetsName((String)table.getValueAt(row, 2-i));
...
//    RiskTreatment.getAssetsThreatsVuln().getThreats().setThreatType((String)table.getValueAt(row, 4-i));
    riskTreatment.getRiskEvaluation().getSfassetsThreatsVuln().getThreats().setThreatName((String)table.getValueAt(row, 3-i));
    riskTreatment.getRiskEvaluation().getSfassetsThreatsVuln().getVulnerabilities().setVulnarabilityName((String)table.getValueAt(row, 4-i));
    ...
    riskTreatment.getRiskEvaluation().getSfassetsThreatsVuln().setAssetsThreatsVulnId((Integer)table.getValueAt(row, 11-i));
    riskTreatment.getRiskEvaluation().getSfassetsThreatsVuln().getThreats().setThreatId((Integer)table.getValueAt(row, 13-i));

    riskTreatment.getRiskEvaluation().getSfassetsThreatsVuln().getVulnerabilities().setVulnarabilityId((Integer)table.getValueAt(row, 11-i));
    riskTreatment.getRiskEvaluation().getSfassetsThreatsVuln().getAssets().setAssetId((Integer)table.getValueAt(row, 11-i));
    riskTreatment.getRiskEvaluation().getSfassetsThreatsVuln().setAssetsThreatsVulnId((Integer)table.getValueAt(row, 12-i));
...
//
        ...
        RiskTreatment = MySQLDAOFactory.getDAOFactory().getSFRiskTreatmentDao().fetchSFRiskTreatment("from SFRiskTreatment");
        for(int i=0;i<RiskTreatment.size();i++){
            ...
            table.getModel().setValueAt(RiskTreatment.get(i).getRiskEvaluation().getSfassetsThreatsVuln().getAssets().getAssetsName(), i, 2);


            table.getModel().setValueAt(RiskTreatment.get(i).getRiskEvaluation().getSfassetsThreatsVuln().getThreats().getThreatName(), i, 3);
            table.getModel().setValueAt(RiskTreatment.get(i).getRiskEvaluation().getSfassetsThreatsVuln().getVulnerabilities().getVulnarabilityName(), i, 4);
            ...
            table.getModel().setValueAt(RiskTreatment.get(i).getRiskEvaluation().getSfassetsThreatsVuln().getAssetsThreatsVulnId(), i, 11);
            table.getModel().setValueAt(RiskTreatment.get(i).getRiskEvaluation().getSfassetsThreatsVuln().getThreats().getThreatId(), i, 12);
            table.getModel().setValueAt(RiskTreatment.get(i).getRiskEvaluation().getSfassetsThreatsVuln().getVulnerabilities().getVulnarabilityId(), i, 13);
            table.getModel().setValueAt(RiskTreatment.get(i).getRiskEvaluation().getSfassetsThreatsVuln().getAssets().getAssetId(), i, 14);
