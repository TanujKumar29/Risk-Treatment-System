 ...
 * @author bhandrah
 */
public class SF_Asset extends javax.swing.JFrame {
            ...
            jTableNewAsset.getColumnModel().getColumn(5).setCellEditor(new DefaultCellEditor(
                ...
                jTableNewAsset.getColumnModel().getColumn(6).setCellEditor(new DefaultCellEditor(
                    ...
                    jTableAssetRegister.setModel(new javax.swing.table.DefaultTableModel(
                        ...
                        new String [] {
                            "Select", "Index", "Asset Name", "AssetType", "AssetOwner", "AssetDescription", "Confidentiality", "Integrity", "Availability", "Asset Value", "AssetId", "ProjectId"
                        }
                    ) {
                        Class[] types = new Class [] {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        SF_Assets asset=readTableRow(jTableNewAsset, 0);
        //------------delet below lines ... after you get Project Id from prev page
      
      //  asset.setAssetId(1);
        //------------------delete ends ------------------------
        if(asset.getAssetsName()==null){
            //JOptionPane.showConfirmDialog(jPanel2,"Please enter the Asset Name",JOptionPane.OK_OPTION);
        ...
        JOptionPane.showConfirmDialog(jPanel2,"Please enter CIA value and click over Asset Value cell to generate Asset Value","Erro",1);
        else {
            int res=MySQLDAOFactory.getDAOFactory().getSF_AssetsDao().insetSF_AssetsToDb(asset);
            if(res!=-1)
            JOptionPane.showConfirmDialog(jPanel2,"Data inserted into Database Successfull!!","Success",JOptionPane.DEFAULT_OPTION);
        }
        loadTable(jTableAssetRegister);
    }//GEN-LAST:event_jButton2ActionPerformed
//private void jTable4.getColumn(2).MouseClicked(java.awt.event.MouseEvent evt)
      //  {
...
//}
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       loadTable(jTableAssetRegister);
        for(int i=0;i<jTableAssetRegister.getRowCount();i++){ jTableAssetRegister.setValueAt(false, i, 0);}
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
                int rowNum[], colNum[];
        int startIndex = -1;
        SF_AssetsDao daoObj = MySQLDAOFactory.getDAOFactory().getSF_AssetsDao();
        ...
        for (int i = (selectColumnVal.length - 1); i >= 0; i--) {
            System.out.println("value of selectColumnVal[i]=="+selectColumnVal[i]);
            if (selectColumnVal[i] == true) {
                startIndex = i;

                System.out.println("Row To be Deleted: " + i);
                SF_Assets assetObj = readTableRow(jTableAssetRegister,i);
                ...
                if (assetObj.getAssetId() == 0) {
                    ...
                    int row = daoObj.deleteSF_AssetsFromDb(assetObj);
...
//*****************************************************My methods****************
private SF_Assets readTableRow(JTable table,int row){
    int i=0;
    ...
    if(table !=jTableNewAsset) {
        ...
        if(table.getValueAt(row, 11)!=null){
            //prj.setSFId((InteIger)table.getModel().getValueAt(row, 11));
            sfid.setSFId((Integer)table.getModel().getValueAt(row, 11));
        }
            asset.setSFId(sfid);
    }
    asset.setSFId(sfid);
...
private void loadTable(JTable table) {
        ...
        List<SF_Assets> allAssets = dAOObj.fetchSF_AssetsListFromDb("from SF_Assets where SFId.SFId="+sfid.getSFId());
        System.out.println("value of all assets=="+allAssets);
        //List <Assets> allAssets = dAOObj.fetchAssetsListFromDb("from ContractReq where assetId = "+asset_id);
        for (int i = 0; i < allAssets.size(); i++) {

            if (table.getModel().getRowCount() <= allAssets.size()) {
            ...
            SF_Assets asset = (SF_Assets) allAssets.get(i);
            // System.out.println("REq"+i+" is:"+req);
            // jTable2.getModel().removeTableModelListener(jTable2);
             System.out.println("Recored to put in GUI Table:"+asset);
            ...
            table.getModel().setValueAt(asset.getAssetsValue(), i, 9);
            //Invisible Columns
            table.getModel().setValueAt(asset.getAssetId(), i, 10);
            table.getModel().setValueAt(asset.getSFId().getSFId(), i, 11);
            System.out.println("Inveisible columns AssetID:"+asset.getAssetId()+" SF_Id:"+asset.getSFId());
