 ...
 * UpdateBU.java
 *
 * Created on Aug 31, 2012, 5:43:32 PM
 */
...
BusinessUnitPojo bup = new BusinessUnitPojo();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("New Business Unit Name : ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        System.out.println("New BU name is: "+jTextField1.getText());
        String updatedBuName = jTextField1.getText();
         String buName =(String)jComboBox1.getSelectedItem();
        int buId=budao.getBuForProjectFromDb(buName);
        bup.setBuId(buId);
        bup.setBuName(updatedBuName);
        budao.modifyBUToDb(bup);
